class RecommendedGameModel {
  int? code;
  RecommendedGameData? data;
  bool? success;

  RecommendedGameModel({this.code, this.data, this.success});

  RecommendedGameModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    data = json['data'] != null ? RecommendedGameData.fromJson(json['data']) : null;
...
class RecommendedGameData {
  String? cursor;
  int? tournamentCount;
  List<Tournaments>? tournaments;
  bool? isLastBatch;

  RecommendedGameData({this.cursor, this.tournamentCount, this.tournaments, this.isLastBatch});

  RecommendedGameData.fromJson(Map<String, dynamic> json) {
    cursor = json['cursor'];
